...
export default function Profile() {
  ...
  const handleUpdateProfile = (values: typeof userInfo) => {
    ...
    const userId =
      jwtPayload.id ?? jwtPayload.user_id ?? jwtPayload.sub ?? jwtPayload.email ?? null;
    if (!userId) return;
  ...
  return (
    <Box py="xl" style={{ maxWidth: '1100px', margin: '0 auto' }}>
      {/* Profile Header */}
      <Paper
        shadow="lg"
        radius="xl"
      ...
      >
        ...
        <Box px="xl" pb="xl" style={{ marginTop: '-70px' }}>
          <Grid align="center">
      ...
      <Grid gutter="lg">
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Paper shadow="sm" p="xl" radius="lg">
            <Stack align="flex-start">
              ...
              >
                <IconBrandGithub size={26} color="#3B82F6" />
              </Box>
              <div>
        ...
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Paper shadow="sm" p="xl" radius="lg" style={{ backgroundColor: '#F8FAFC' }}>
            <Stack align="flex-start">
              <Box
                style={{
                  width: 55,
              ...
              >
                <IconMail size={26} color="#16A34A" />
              </Box>
              <div>
                <Text fw={600}>Check-in Time</Text>
                <Text size="lg" mt={5}>
                  {userInfo.check_in_time}
                </Text>
              </div>
            </Stack>
          </Paper>
        ...
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Paper shadow="sm" p="xl" radius="lg" style={{ backgroundColor: '#FFF1F2' }}>
            <Stack align="flex-start">
              <Box
                style={{
                  width: 55,
              ...
              >
                <IconPhone size={26} color="#DB2777" />
              </Box>
              <div>
                <Text fw={600}>Check-out Time</Text>
                <Text size="lg" mt={5}>
                  {userInfo.check_out_time}
                </Text>
              </div>
            </Stack>
          </Paper>
      ...
      <Modal
        ...
        title={<Text size="xl" fw={700}>Edit Profile Information</Text>}
        size="xl"
        radius="lg"
        padding="xl"
        overlayProps={{
        ...
        >
          <Stack gap="lg">
            <Paper p="lg" radius="md" withBorder>
              <Group align="flex-start" gap="xl">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <FileInput
                    accept="image/*"
                    value={typeof userInfo.avatar === 'string' ? null : userInfo.avatar}
                    onChange={(file) => setUserInfo({ ...userInfo, avatar: file })}
              ...
              <Grid>
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <Select
                    ...
                    data={['admin', 'user', 'manager', 'developer', 'team lead']}
                    size="md"
                  />
                </Grid.Col>
                <Grid.Col span={{ base: 12, md: 6 }}>
                ...
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <TextInput
                    ...
                    onChange={(e) =>
                      setUserInfo({ ...userInfo, check_in_time: e.target.value })
                    }
                    size="md"
                  />
                </Grid.Col>
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <TextInput
                    ...
                    onChange={(e) =>
                      setUserInfo({ ...userInfo, check_out_time: e.target.value })
                    }
                    size="md"
                  />
                </Grid.Col>
            ...
            <Group justify="flex-end" mt="md">
              <Button variant="light" onClick={() => setIsEditing(false)} radius="md">
                Cancel
              </Button>
